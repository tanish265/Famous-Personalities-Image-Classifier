...
def classify_image(image_base64_data, file_path=None):
    ...
    for img in imgs:
        ...
        result.append({
            'class': class_number_to_name(__model.predict_classes(scalled_raw_img)[0]),
            'class_probability': np.around(__model.predict_proba(scalled_raw_img)*100,2).tolist()[0],
...
def load_saved_artifacts():
    ...
    global __model
    if __model is None:
        # with open('./artifacts/my_model.h5', 'rb') as f:
        __model = load_model('./artifacts/my_model.h5')
...
if __name__ == '__main__':
    ...
    print(classify_image(None, "./test_images/modib.jpg"))
    # print(classify_image(None, "./test_images/federer2.jpg"))
    # print(classify_image(None, "./test_images/noo.jpg"))
